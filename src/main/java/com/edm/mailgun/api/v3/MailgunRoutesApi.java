...
import com.edm.mailgun.model.routes.Route;
import com.edm.mailgun.model.routes.RoutesListResponse;
import com.edm.mailgun.model.routes.RoutesPageRequest;
import com.edm.mailgun.model.routes.RoutesRequest;
import com.edm.mailgun.model.routes.RoutesResponse;
import com.edm.mailgun.model.routes.SingleRouteResponse;
...
public interface MailgunRoutesApi extends MailgunApi {
     ...
     *
     * @return {@link com.edm.mailgun.model.routes.RoutesListResponse}
     */
     ...
     * Note: that routes are defined globally, per account, not per domain as most of other API calls.
     *
     * @param pageRequest {@link com.edm.mailgun.model.routes.RoutesPageRequest}
     ...
     * @return {@link com.edm.mailgun.model.routes.SingleRouteResponse}
     */
     ...
     * </p>
     *
     * @param request {@link com.edm.mailgun.model.routes.RoutesRequest}
     * @return {@link com.edm.mailgun.model.routes.RoutesResponse}
     */
     ...
     * @param id      ID of the route
     * @param request {@link RoutesRequest}
     * @return {@link com.edm.mailgun.model.routes.Route}
     */
    @Headers("Content-Type: multipart/form-data")
