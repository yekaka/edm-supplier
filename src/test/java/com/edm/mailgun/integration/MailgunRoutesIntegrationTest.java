...
import com.edm.mailgun.api.v3.MailgunRoutesApi;
...
class MailgunRoutesIntegrationTest {
    ...
    static void beforeAll() {
        mailgunRoutesApi = MailgunClient.config(IntegrationTestConstants.PRIVATE_API_KEY)
    ...
    void createRouteSuccessTest() {
        String action_1 = "forward('" + TestConstants.TEST_EMAIL_2 + "')";
        String action_2 = "forward('" + TestConstants.TEST_EMAIL_3 + "')";
    ...
    void updateRouteSuccessTest() {
        String newAction = "forward('" + TestConstants.TEST_EMAIL_4 + "')";
        RoutesRequest routesRequest = RoutesRequest.builder()
                .priority(1)
                .action(newAction)
                .build();
